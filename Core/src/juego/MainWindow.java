	...
	public MainWindow() {
		...
		btnObjeto.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				JOptionPane.showMessageDialog(rootPane, "Has causado 10 puntos de daño");
					...
					JOptionPane.showMessageDialog(rootPane, "No te quedan bombas, o lo has escrito mal (tramposo/inútil)");
				}
			}
		});
